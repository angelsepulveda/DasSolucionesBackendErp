namespace Membership.Modules.Features.Register;
...
internal sealed class RegisterModuleHandler(MembershipDbContext dbContext) : ICommandHandler<RegisterModuleCommand>
{
    public async Task<Unit> Handle(RegisterModuleCommand request, CancellationToken cancellationToken)
    {
